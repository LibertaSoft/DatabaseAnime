...
####[Баги]
- [ ] При входе в настройки слетает вендорный шрифт, в 1.2.0 было норм.
- [ ] 

####[Задумки]
- [ ] Придумать валидацию данных на основе шаблона "Уведомление", по мотива
  [этой](http://habrahabr.ru/company/piter/blog/270331/) статьи.
- [ ] Возможно объеденить валидацию данных при чтении из БД строки и приведению
  к integer в одну переменную с побитовыми флагами.
- [ ] Добавлять к записям версию программы на которой последний раз
  редактировалась запись, для возможного, последующего отслеживания старых
  записей и не совместимостей.

####[В процессе]
- [ ] Добавить раздел с настройкой горячих клавиш
- [ ] Реализовать возможность D&D с интернета, и так же подумать над вставкой
  ссылки
- [x] Запрос подстверждения на удаление стиля.
- [x] Отключение кнопки сохранения изменений в стиле, после их сохранения.
- [ ] Написание deploy-скриптов
- [ ] Избавиться от диалоговых окон
- [ ] Обновить переводы
- Не исправлено:
  - Для переключения на системный стиль требуется перезапуск.
...
- [ ] Исправить, отстутствие прокрутки при длинном описании
