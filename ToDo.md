...
####[В процессе]
- [ ] Обновить переводы
- [ ] Выбор поля отображаемого в общем списке (Title или AltTitle)
- [ ] Опциональное отключение поиска на сайте shikimori.org
...
- [x] Рефакторинг
  ...
  - [ ] Реализация класса для "ключей" полей в БД
