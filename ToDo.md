...
- [x] Путь к переводам снова изменён. Теперь: 
  - Linux / MacOS(?)
  ...
  - Windows
    ...
    - "/ProgramData/LibertaSoft/DatabaseAnime/l10n/"
    - "./l10n/"
    - "./data/l10n/"
...
- Не было исправлено:
  - Краш QtSql при экспорте на 748800 записях, при этом объём ОЗУ - 1,5гб; Файл на диске - 1 219 669Mb
